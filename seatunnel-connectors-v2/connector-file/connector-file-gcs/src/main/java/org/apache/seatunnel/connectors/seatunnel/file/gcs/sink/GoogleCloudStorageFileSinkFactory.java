...
import org.apache.seatunnel.connectors.seatunnel.file.gcs.config.GoogleCloudStorageFileSinkOptions;
...
public class GoogleCloudStorageFileSinkFactory extends BaseMultipleTableFileSinkFactory {
    @Override
    ...
    public TableSink createSink(TableSinkFactoryContext context) {
        ...
        return () -> new GoogleCloudStorageFileSink(readonlyConfig, catalogTable);
    }
    ...
    public OptionRule optionRule() {
        return OptionRule.builder()
                ...
                .required(GoogleCloudStorageFileSinkOptions.BUCKET)
                .optional(GoogleCloudStorageFileSinkOptions.PROJECT_ID)
                .optional(GoogleCloudStorageFileSinkOptions.CREDENTIALS_PATH)
