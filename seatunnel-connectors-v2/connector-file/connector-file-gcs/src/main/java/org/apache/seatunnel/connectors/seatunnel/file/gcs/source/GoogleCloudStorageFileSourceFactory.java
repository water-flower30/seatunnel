...
import org.apache.seatunnel.connectors.seatunnel.file.gcs.config.GoogleCloudStorageFileSourceOptions;
...
public class GoogleCloudStorageFileSourceFactory implements TableSourceFactory {
    @Override
    ...
    public <T, SplitT extends SourceSplit, StateT extends Serializable>
        ...
        return () ->
                (SeaTunnelSource<T, SplitT, StateT>)
                        new GoogleCloudStorageFileSource(context.getOptions());
    }

    @Override
    public OptionRule optionRule() {
        return OptionRule.builder()
                .exclusive(TableSchemaOptions.TABLE_CONFIGS, FileBaseOptions.FILE_PATH)
                .optional(GoogleCloudStorageFileSourceOptions.BUCKET)
                .optional(GoogleCloudStorageFileSourceOptions.PROJECT_ID)
                .optional(GoogleCloudStorageFileSourceOptions.CREDENTIALS_PATH)
    ...
    public Class<? extends SeaTunnelSource> getSourceClass() {
        return GoogleCloudStorageFileSource.class;
    }
}
