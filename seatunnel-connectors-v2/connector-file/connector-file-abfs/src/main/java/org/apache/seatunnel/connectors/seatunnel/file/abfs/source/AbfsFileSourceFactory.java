...
import org.apache.seatunnel.connectors.seatunnel.file.abfs.config.AbfsFileSourceOptions;
...
public class AbfsFileSourceFactory implements TableSourceFactory {
    @Override
    ...
    public <T, SplitT extends SourceSplit, StateT extends Serializable>
        ...
        return () -> (SeaTunnelSource<T, SplitT, StateT>) new AbfsFileSource(context.getOptions());
    }

    @Override
    public OptionRule optionRule() {
        return OptionRule.builder()
                .exclusive(AbfsFileSourceOptions.TABLE_CONFIGS, FileBaseOptions.FILE_PATH)
                .optional(AbfsFileSourceOptions.CONTAINER)
                .optional(AbfsFileSourceOptions.ACCOUNT_NAME)
                .optional(AbfsFileSourceOptions.ACCOUNT_KEY)
                .optional(AbfsFileSourceOptions.ENDPOINT)
