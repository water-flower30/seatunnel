...
package org.apache.seatunnel.connectors.seatunnel.file.abfs.sink;
...
import org.apache.seatunnel.connectors.seatunnel.file.abfs.config.AbfsFileSinkOptions;
...
public class AbfsFileSinkFactory extends BaseMultipleTableFileSinkFactory {
    @Override
    ...
    public TableSink createSink(TableSinkFactoryContext context) {
        ...
        return () -> new AbfsFileSink(readonlyConfig, catalogTable);
    }
    ...
    public OptionRule optionRule() {
        return OptionRule.builder()
                ...
                .required(AbfsFileSinkOptions.CONTAINER)
                .required(AbfsFileSinkOptions.ACCOUNT_NAME)
                .required(AbfsFileSinkOptions.ACCOUNT_KEY)
                .optional(AbfsFileSinkOptions.ENDPOINT)
